...
def create_cached_features(match_list, destination):
    for i in range(0, len(match_list)):
        if i % 100 is 0:
            ...
            #with open("cache_progress.txt", "a") as myfile:
		    #    myfile.write(str(datetime.now()) + " current i is" + str(i))
            #    myfile.write("\n")
...
test_matches = get_all_matches('/storage/hlynur/unprocessed/test/')
print(len(test_matches))
test_dest = '/storage/hlynur/cache/test/'
create_cached_features(test_matches, test_dest)
print("done")
