...
def semantic_loss(logits, labels, o):
    ...
    loss = tf.nn.sparse_softmax_cross_entropy_with_logits(logits=logits_reshaped, labels=labels_reshaped)
    return loss

def create_othello_net_7l_43():
...
#    conv10_out = conv_nonparams(conv9_out, conv10_weights, conv10_biases)
    ...
    score_out = final_conv_nonparams(conv7_out, score_weights, score_biases)
...
#    conv10_out = conv_nonparams(conv9_out, conv10_weights, conv10_biases)
    ...
    score_weights = weight_variable([k, k, i, o])
    score_biases = bias_variable([o])
    score_out = final_conv_nonparams(conv9_out, score_weights, score_biases)
